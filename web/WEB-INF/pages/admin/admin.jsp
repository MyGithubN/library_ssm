...
<head>
    ...
    <script src="<%=basePath%>static/js/admin/admin.js"></script>
</head>
                        ...
                        <form class="form-horizontal" id="form_add">
                            <div class="row">
                                <div class="col-lg-12 form-group">
                                    <label class="col-lg-3 control-label" for="add_ano"><label class="text-danger">*&nbsp;</label>管理员编号</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" id="add_ano" type="text" value="">
                                        <label class="control-label" for="add_ano"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 form-group has">
                                    <label class="col-lg-3 control-label" for="add_aname"><label class="text-danger">*&nbsp;</label>管理员名称</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" id="add_aname" type="text" value="">
                                        <label class="control-label" for="add_aname"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form class="form-horizontal" id="form_update">
                            ...
                            <div class="row">
                                <div class="col-lg-12 form-group">
                                    <label class="col-lg-3 control-label" for="update_ano"><label class="text-danger">*&nbsp;</label>管理员编号</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" id="update_ano" type="text" value="" disabled>
                                        <label class="control-label" for="update_ano"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 form-group has">
                                    <label class="col-lg-3 control-label" for="update_aname"><label class="text-danger">*&nbsp;</label>管理员名称</label>
                                    <div class="col-lg-9">
                                        <input class="form-control" id="update_aname" type="text" value="">
                                        <label class="control-label" for="update_aname"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
